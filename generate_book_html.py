...
OUTPUT_HTML = os.path.join(BASE_DIR, "카니보어_인쇄본.html")
...
<div class="toc">
    ...
    <div class="toc-chapter">3장. 조리법과 주간 식단</div>
    <div class="toc-chapter">4장. 육식 기반 치유 식단</div>
    <div class="toc-chapter">5장. 간헐적 단식과 카니보어</div>
    <div class="toc-part">제6부 &mdash; 자주 묻는 질문과 사례</div>
    <div class="toc-chapter">1장. Q&amp;A</div>
    <div class="toc-chapter">2장. 육식에 대한 16가지 오해</div>
    <div class="toc-chapter">3장. 회복 사례 모음</div>
